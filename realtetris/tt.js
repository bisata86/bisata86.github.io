...
var hitDistance = disatancebetweenpoints/2;
var gamevel = 10;
var myInterval;
								...
								if(objects[i].eraser) {
									...
									if(fromshapenr!=undefined)  {
										...
										if(figure.length>0) {
											...
											//  allmoving = true;
											// for (var ijji = objects.length - 1; ijji >= 0; ijji--) {
											//  	objects[ijji].fine = false;
											//  	objects[ijji].moving = true;
											//  };
